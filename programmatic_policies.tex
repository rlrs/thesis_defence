...
\note[itemize]{
    \itme Okay, so how would we go about
    \item A really well-known, important problem with this.
...
\begin{frame}{Dataset Aggregation}
    \begin{itemize}
        \item 
    \end{itemize}
...
\note[itemize]{
    ...
    \item A solution is to do what I call interactive imitation. Dataset Aggregation or DAgger is an early example of interactive imitation.
    \item 
}
